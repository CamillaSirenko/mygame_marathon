...
player_rect = player.get_rect().move(50, HEIGHT//2)

player_move_down = [0, 4]
player_move_right = [4,  0]
player_move_top= [-4, 0]
player_move_left=[ 0, -4]
...
pygame.time.set_timer(CREATE_ENEMY, 1600)
...
while playing:
    ...
    main_display.blit(FONT.render(str(score),  True,  COLOR_ORANGE), (WIDTH-50, 20))
